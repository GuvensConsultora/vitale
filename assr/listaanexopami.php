...
<FORM NAME="cargar" ACTION="listanexopami.php" METHOD="POST">
...
<DIV ALIGN= CENTER><H4>al I.N.S.J.P.-<H4></DIV>
<hr>
<tr>
    <tr>
...
<input type=text name=pano title='Ingresar el periodod bajo análisis' value='2020' size=4></td></tr>

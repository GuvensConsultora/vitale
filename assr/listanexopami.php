	...
	$sql2="SELECT idmov,
		...
		FROM 
			...
			SELECT
			        ...
			        periododmes,
			        periodoano,
			        to_char( importe, '$999999D99')as importe,
    				carnet,
				ccie,
    				idcentro 
    			FROM 
...
{
  $contador = $contador +1 ;
  echo "<FORM name='modiflinea' action='modificalineapami.php' method='POST'>";
  echo "<tr>";
  ...
  echo "$row2[9] </td><td><p align=center>";
  echo "$row2[3]</p></td><td>";
